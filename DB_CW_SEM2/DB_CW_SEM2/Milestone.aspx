<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Milestone.aspx.cs" Inherits="DB_CW_SEM2.Milestone" %>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Milestone Management</a>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="M_ID" DataSourceID="SqlDataSource1">
                <Columns>
            ...
            <div class="new-button-container">
                <asp:FormView ID="FormView1" runat="server" DataKeyNames="M_ID" DataSourceID="SqlDataSource1">
                    <EditItemTemplate>
                        M_ID:
                        <asp:Label ID="M_IDLabel1" runat="server" Text='<%# Eval("M_ID") %>' />
                        <br />
                        M_NMAE:
                        <asp:TextBox ID="M_NMAETextBox" runat="server" Text='<%# Bind("M_NMAE") %>' />
                        <br />
                        M_DUEDATE:
                        <asp:TextBox ID="M_DUEDATETextBox" runat="server" Text='<%# Bind("M_DUEDATE") %>' />
                        <br />
                        P_ID:
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM &quot;MILESTONE&quot; WHERE &quot;M_ID&quot; = :M_ID" InsertCommand="INSERT INTO &quot;MILESTONE&quot; (&quot;M_ID&quot;, &quot;M_NMAE&quot;, &quot;M_DUEDATE&quot;, &quot;P_ID&quot;) VALUES (:M_ID, :M_NMAE, :M_DUEDATE, :P_ID)" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM &quot;MILESTONE&quot;" UpdateCommand="UPDATE &quot;MILESTONE&quot; SET &quot;M_NMAE&quot; = :M_NMAE, &quot;M_DUEDATE&quot; = :M_DUEDATE, &quot;P_ID&quot; = :P_ID WHERE &quot;M_ID&quot; = :M_ID">
                <DeleteParameters>
                    <asp:Parameter Name="M_ID" Type="Decimal" />
                </DeleteParameters>
                <InsertParameters>
                    <asp:Parameter Name="M_ID" Type="Decimal" />
                    <asp:Parameter Name="M_NMAE" Type="String" />
                    <asp:Parameter Name="M_DUEDATE" Type="DateTime" />
